...
class Matches
{
    ...
    private:
    void pairwiseMatch(const vector<KeyPoints>&keypoints1,const vector<KeyPoints>&keypoints2,const Mat&descriptors1,const Mat&descriptors2,vector<DMatch> matches);
